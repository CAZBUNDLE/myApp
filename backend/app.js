...
houses.push( {id:4,price:2995000,area:"Edgbaston",type:"Luxeryhouse",image:`https://www.rightmove.co.uk/properties/87749239#/media?id=media0&ref=photoCollage`})
houses.push( {id:5,price:27500,area:"Handsworth",type:"Flat",image:`https://media.rightmove.co.uk/dir/crop/10:9-16:9/108k/107051/78903606/107051_RS0730_IMG_11_0000_max_476x317.jpeg`})
houses.push( {id:6,price:27500,area:"Handsworth",type:"Flat",image:`https://media.rightmove.co.uk/dir/crop/10:9-16:9/108k/107051/78903606/107051_RS0730_IMG_11_0000_max_476x317.jpeg`})
...
app.post("/sms", (req, res) => {
  let msg=`Hello ${req.body.name}, would like to book a viewing for ${req.body.id} on ${req.body.date} at ${req.body.time}  notes:${req.body.msg}`
   sendSMS(msg,'07572660331') //this would be the agents number 
   let custConfirm = `thanks Bab see you then`
  sendSMS(custConfirm,req.body.tel) // you can use more than one number here is the cusomters number 
